...
_bool CModel::Play_Animation(_float fTimeDelta)	
{
	...
	else
	{
		...
		/*_bool   isFinished = */
		m_Animations[m_iCurrentAnimIndex]->Update_TransformationMatrix(fTimeDelta, m_Bones, &m_fCurrentTrackPosition, m_CurrentKeyFrameIndices[m_iCurrentAnimIndex], m_isAnimLoop);
