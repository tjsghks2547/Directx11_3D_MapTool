...
{
    strcpy_s(m_szName, "Prototype_GameObject_ST_LiftTable_a2_sui_00");
...
CST_LiftTable_a2_sui_00* CST_LiftTable_a2_sui_00::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    ...
    {
        MSG_BOX("Failed To Created : ST_LiftTable_a2_sui_00");
...
CGameObject* CST_LiftTable_a2_sui_00::Clone(void* pArg)
{
    ...
    {
        MSG_BOX("Failed To Cloned : ST_LiftTable_a2_sui_00");
        Safe_Release(pInstance);
    }
